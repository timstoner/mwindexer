...
/**
 * Quickie little class for sending properly encoded, prettily indented XML
 * output to a stream. There is no namespace support, so prefixes and xmlns
 * attributes must be managed manually.
 */
public class XmlWriter {
	...
	/**
	 * Write an empty element, such as <el/>, on a standalone line. Takes an
	...
	public void emptyElement(String element, String[][] attributes)
			throws IOException {
	...
	/**
	 * Write an element open tag, such as <el>, on a standalone line. Takes an
	 * optional dictionary of attributes.
	 * 
	 * @throws IOException
	 */
	...
	public void openElement(String element, String[][] attributes)
			throws IOException {
		startElement(element, attributes, ">\n");
	}

	/**
	 * Write an element close tag, such as </el>, on a standalone line. If
	 * indent=False is passed, indentation will not be added.
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Write an element with a text node included, such as <el>foo</el>, on a
	 * standalone line. If the text is empty, an empty element will be output as
	 * <el/>. Takes an optional list of tuples with attribute names and values.
	 * 
	 * @throws IOException
	 */
	...
	public void textElement(String element, String text, String[][] attributes)
			throws IOException {
	...
	void startElement(String element, String[][] attributes, String terminator)
			throws IOException {
